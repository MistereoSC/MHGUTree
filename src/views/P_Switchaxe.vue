<template>
  <div>
    <Navbar title="Switch Axe"></Navbar>
    <Filter 
      @reset="filterReset" 
      @apply="filterApply"
      special="SA"
...
<script>
  ...
  import Tree from '../../public/json/weapons/trees/FLAT_switchaxe.json'
  ...
  created () {
    ...
    console.log(this.wpntree.length+" items loaded for Switchaxe.")
  },
  methods: {
    filterApply(t){
      for(var i = 0; i <this.wpntree.length; i++){
