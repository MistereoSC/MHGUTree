<template>
  <div>
    <Navbar title="Great Sword"></Navbar>
    <Filter 
      @reset="filterReset" 
      @apply="filterApply"
    ></Filter>
...
<script>
  ...
  import Tree from '../../public/json/weapons/trees/FLAT_greatsword.json'
  ...
  created () {
    ...
    console.log(this.wpntree.length+" items loaded for Great Sword.")
  },
  methods: {
    filterApply(t){
      for(var i = 0; i <this.wpntree.length; i++){
